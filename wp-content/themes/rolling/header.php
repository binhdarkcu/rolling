	                        ...
	                        <div class="navigation-menu">
	                            <div class="navbar">
	                                ...
	                                <div class="navbar-collapse collapse">
                                        <ul id="onepage-menu" class="nav navbar-nav navbar-right"><li id="menu-item-9" class="smoth-scroll menu-item menu-item-type-custom menu-item-object-custom menu-item-9 active"><a href="#home">Home</a></li>
											<li id="menu-item-10" class="smoth-scroll menu-item menu-item-type-custom menu-item-object-custom menu-item-10"><a href="#about-us">About Us</a></li>
											<li id="menu-item-11" class="smoth-scroll menu-item menu-item-type-custom menu-item-object-custom menu-item-11"><a href="#expertise">Expertise</a></li>
											<li id="menu-item-12" class="smoth-scroll menu-item menu-item-type-custom menu-item-object-custom menu-item-12"><a href="#our-team">Our Team</a></li>
											<li id="menu-item-13" class="smoth-scroll menu-item menu-item-type-custom menu-item-object-custom menu-item-13"><a href="#testimonials">Testimonial</a></li>
											<li id="menu-item-14" class="smoth-scroll menu-item menu-item-type-custom menu-item-object-custom menu-item-14"><a href="#contact">Contact</a></li>
										</ul>	                                
									</div>
	                            </div>
	                        </div>
