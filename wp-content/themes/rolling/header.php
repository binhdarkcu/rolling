<!DOCTYPE html>
<!-- saved from url=(0049)http://www.uipasta.com/wordpress-preview/rolling/ -->
<html lang="en-US">
	<head>
		...
		<link rel="pingback" href="http://www.uipasta.com/wordpress-preview/rolling/xmlrpc.php">
        <link rel="apple-touch-icon" sizes="129x129" href="http://www.uipasta.com/wordpress-preview/rolling/wp-content/themes/rolling/assets/images/apple-touch-icon.png">
	...
	<link rel="stylesheet" id="typedjs-style-css" href="assets/css/typedjs.min.css" type="text/css" media="all">
	<link rel="stylesheet" id="plugin-css" href="assets/css/plugin.css" type="text/css" media="all">
	        ...
	        <div class="header-top-area">
	            <div class="container">
	                <div class="row">
	                    <div class="col-sm-3">
	                        <div class="logo">
								<h1 class="site-title"><a href="<?php echo HOME_URL;?>" rel="home">Rolling – Free Wordpress Theme</a></h1>
	                        ...
	                        <div class="navigation-menu">
	                            <div class="navbar">
	                                ...
	                                <div class="navbar-collapse collapse">
                                        <ul id="onepage-menu" class="nav navbar-nav navbar-right"><li id="menu-item-9" class="smoth-scroll menu-item menu-item-type-custom menu-item-object-custom menu-item-9 active"><a href="http://www.uipasta.com/wordpress-preview/rolling/#home">Home</a></li>
											<li id="menu-item-10" class="smoth-scroll menu-item menu-item-type-custom menu-item-object-custom menu-item-10"><a href="http://www.uipasta.com/wordpress-preview/rolling/#about">About</a></li>
											<li id="menu-item-11" class="smoth-scroll menu-item menu-item-type-custom menu-item-object-custom menu-item-11"><a href="http://www.uipasta.com/wordpress-preview/rolling/#portfolio">Portfolio</a></li>
											<li id="menu-item-12" class="smoth-scroll menu-item menu-item-type-custom menu-item-object-custom menu-item-12"><a href="http://www.uipasta.com/wordpress-preview/rolling/#testimonials">Testimonial</a></li>
											<li id="menu-item-13" class="smoth-scroll menu-item menu-item-type-custom menu-item-object-custom menu-item-13"><a href="http://www.uipasta.com/wordpress-preview/rolling/#services">Services</a></li>
											<li id="menu-item-14" class="smoth-scroll menu-item menu-item-type-custom menu-item-object-custom menu-item-14"><a href="http://www.uipasta.com/wordpress-preview/rolling/#contact">Contact</a></li>
										</ul>	                                
									</div>
	                            </div>
	                        </div>
