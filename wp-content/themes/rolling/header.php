	                        ...
	                        <div class="navigation-menu">
	                            <div class="navbar">
	                                ...
	                                <div class="navbar-collapse collapse">
	                                	<ul class="language">
											<li><a class="<?php if(qtrans_getLanguage() == 'en') echo 'active';?>" href="<?php echo HOME_URL?>/?lang=en">EN</a></li>
											<li><span>/</span></li>
                                        ...
                                        <?php
											if ( has_nav_menu( 'primary_menus' ) ) {
												...
												echo '<ul class="smoth-scroll nav navbar-nav navbar-right"><li class="smoth-scroll"><a target="_blank" href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '">' . esc_html__( 'Create Primary Menu', 'rolling' ) . '</a></li></ul>';
											}
										?>
